...
const AboutComponents = () => {
  return (
    <section className="min-h-screen bg-gray-100 py-8 flex items-center">
      <div className="container-primary grid lg:grid-cols-2 gap-10 md:gap-16">
        <div className="grid md:grid-cols-2 gap-5">
          <div className="relative md:-top-10 h-60 md:h-96 group" data-aos="fade-up" data-aos-duration="1100">
            ...
            <img
              ...
              alt="about spicetra"
              loading="lazy"
              className="h-60 md:h-96 w-full object-cover rounded-md shadow-md group-hover:translate-x-3 group-hover:translate-y-3 duration-300 ease-in-out"
            />
          </div>
          <div className="relative md:top-10 h-60 md:h-96 group" data-aos="fade-up" data-aos-duration="1100">
            <div className="absolute hidden md:block w-full h-full border-2 border-Accent-secondary rounded-md top-3 left-3 group-hover:-translate-x-3 group-hover:-translate-y-3 duration-300 ease-in-out"></div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2" data-aos="fade-left" data-aos-duration="1100">
            <RiShipLine className="text-Accent-secondary text-2xl" />
            <h1 className="font-inter font-semibold text-Primary text-lg">
              About Us – Spicetra
            </h1>
          </div>
          <h2 className="font-Playfair font-extrabold text-4xl md:leading-snug text-Primary" data-aos="fade-left" data-aos-duration="1100">
            Spicetra is an exporter of premium spices and seafood.
          </h2>
          <p className="font-inter text-Dark/80" data-aos="fade-left" data-aos-duration="1100">
          ...
          <div className="flex flex-col gap-4">
            {features.map((item, i) => (
              <div key={i} className="flex items-center gap-2" data-aos="fade-left" data-aos-duration="1100">
